    ...
    return (
        <div className="my-14 lg:h-screen lg:w-fit lg:fixed lg:mt-20">
            ...
            <div className="hidden lg:flex lg:flex-col lg:my-16">
                <Link className="group flex items-center py-3 w-fit" href="#about"><span className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"></span><span className="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">About</span></Link>
                <Link className="group flex items-center py-3 w-fit" href="#experience"><span className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"></span><span className="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">Experience</span></Link>
                <Link className="group flex items-center py-3 w-fit" href="#project"><span className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"></span><span className="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">Project</span></Link>

            </div>

            <div className="flex flex-row my-4 w-fit lg:inset-x-100 lg:bottom-0 lg:my-20 lg:fixed">
                <Link href='https://www.instagram.com/winstencoellins' className="hover:cursor-pointer mr-3 lg:mr-6"><Image src={instagram} alt='instagram' width={30} height={30} className=""/></Link>
                <Link href='https://www.linkedin.com/in/winsten-coellins' className="hover:cursor-pointer mr-3 lg:mr-6"><Image src={linkedin} alt='linkedin' width={30} height={30} className=""/></Link>
                <Link href='https://github.com/winstencoellins' className="hover:cursor-pointer mr-3 lg:mr-6"><Image src={github} alt='instagram' width={30} height={30} className=""/></Link>
            </div>
        </div>
    )
}